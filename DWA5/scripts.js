...
form.addEventListener("submit", (event) => {
  ...
  //used a if and else statement to check whether either of the input fields (dividend or divider) are empty before performing the division. If either of them is empty, it displays the error message
  if(dividend === '' || divider === ''){
  ...
  // added an else if statement that will throw an error when nin-numeric values are entered
    ...
    //This line of code sets the HTML content of the <body>
